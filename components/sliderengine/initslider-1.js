jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        transition:"threedflipwithzoom,threedwithzoom,flip,threedflip,cssslide,threedtiles,kenburns,threedhorizontalwithzoom,flipwithzoom,threedhorizontal,threed",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
